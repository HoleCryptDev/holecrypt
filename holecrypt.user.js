...
// ==/UserScript==
(async () => {
    var js_openpgp = document.createElement('script');
    js_openpgp.type = 'text/javascript';
    js_openpgp.src = 'https://cdnjs.cloudflare.com/ajax/libs/openpgp/4.10.7/compat/openpgp.min.js';
    document.getElementsByTagName('head')[0].appendChild(js_openpgp);

    function sleep(ms) {
        return new Promise(resolve => setTimeout(resolve, ms));
    }
    while (typeof unsafeWindow.openpgp == 'undefined') {
        await sleep(100);
    }
    let openpgp = unsafeWindow.openpgp;
